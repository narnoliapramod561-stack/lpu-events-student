-- 20260820000002_seed_official_taxonomy.sql
-- Seed official platform categories and subcategories in production

-- 1. Insert/Update Official Categories
...
-- Deactivate any other unused category records
